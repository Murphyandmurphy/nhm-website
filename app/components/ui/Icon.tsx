 ...
 */
export function Icon({ name, size = 20, stroke = 1.75, color = "currentColor", className, style }: IconProps) {
  ...
  return <Cmp size={size} strokeWidth={stroke} color={color} className={className} style={style} aria-hidden="true" />;
}
